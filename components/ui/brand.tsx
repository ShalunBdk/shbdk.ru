...
import Tailwind_CSS from '~/icons/tailwind.svg'
...
import Prometheus from '~/icons/prometheus.svg'
...
export let BrandsMap = {
  ...
  Tailwind_CSS: {
    Icon: Tailwind_CSS,
    url: 'https://thttps://tailwindcss.com/',
  },
  Turborepo: {
    Icon: Turborepo,
...
export function Brand(props: {
  ...
  return (
    <Link href={`${url}?ref=shbdk.ru`} className={className}>
